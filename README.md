# CADAM Container Edition

This is a customized fork of Zach Dive's CADAM, containerized to support dynamic runtime environment variables, semantic versioning, and automatic compilation via GitHub Actions.

## 🐳 Running with Docker

This image is built using GitHub Actions and pushed to GitHub Container Registry (GHCR):

```bash
docker pull ghcr.io/spelech/cadamcontainer:latest
```
